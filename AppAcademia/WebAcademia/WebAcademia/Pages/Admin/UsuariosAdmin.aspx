<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsuariosAdmin.aspx.cs" Inherits="WebAcademia.Pages.Admin.UsuariosAdmin" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="courses-card">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
                <h4 class="m-0">
                    <i class="fas fa-list-ul me-2 text-primary"></i>Lista de Usuarios
                </h4>
                <div class="d-flex flex-wrap gap-2">
                    <a href="AdminDashboard.aspx" class="btn btn-outline-secondary">
                        <i class="fas fa-home me-2"></i>Volver
                    </a>
                    <a href="UsuariosFormAdmin.aspx" class="btn btn-success">
            ...
            <div class="mb-4 p-3 bg-light rounded shadow-sm">
                <div class="row g-2 align-items-end">
                    <%-- 🔎 Nombre del usuario --%>
                    <div class="col-md-3">
                        <label for="txtBuscarNombre" class="form-label">Nombre Usuario</label>
                        <asp:TextBox ID="txtBuscarNombre" runat="server" CssClass="form-control" placeholder="Ej: Gustavo"></asp:TextBox>
                    </div>
                    ...
                    <%-- ✅ Email (más ancho) --%>
                    <div class="col-md-5">
                        <label for="txtBuscarEmail" class="form-label">Email</label>
                        <asp:TextBox ID="txtBuscarEmail" runat="server" CssClass="form-control" placeholder="Ej: Gustavo@gmail.com"></asp:TextBox>
                    </div>

                    <%-- ✅ Botones (más a la derecha, más compactos) --%>
